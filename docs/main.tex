...
\begin{minipage}{.5\textwidth}
	...
	\captionof{figure}{OpenMP results of Cage\_ 4.}
\end{minipage}
\end{figure}
...
\begin{minipage}{.45\textwidth}
	\centering
	\includegraphics[width=.8\linewidth]{openmp.png}
	\captionof{figure}{Comparison between OpenMP \newline and Sequential efficiency.}
\end{minipage}%
\begin{minipage}{.45\textwidth}
	\centering
  	\includegraphics[width=.8\linewidth]{csrcuda.png}
	\captionof{figure}{CSR efficiency with results from the several methods.}
\end{minipage}
\end{figure}
...
\begin{figure}[!htb]
 \centering
  ...
  \captionof{figure}{Ellpack efficiency with results from the several methods.}
\end{figure}
