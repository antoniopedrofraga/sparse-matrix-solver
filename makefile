...
all:
	nvcc -O3 -std=c++11 -Xcompiler -fopenmp -gencode arch=compute_35,code=sm_35 -D_MWAITXINTRIN_H_INCLUDED -D_FORCE_INLINES -D__STRICT_ANSI__ src/main.cpp src/*/*.cpp src/methods/cuda.cu -o bin/solver
memcheck:
