...
set output \"./outputs/csr.png\"; plot \"./outputs/sequential_sorted.csv\" using 1:2 title 'Sequential' with linespoints ls 3 lw 2 lc rgb '#0060ad' pt 9 ps 1, \
     ...
     \"./outputs/cuda_sorted.csv\" using 1:2 title 'CUDA VM' with linespoints ls 1 lw 2 lc rgb '#31a354' pt 7 ps 1, \
      \"./outputs/cuda_sorted.csv\" using 1:3 title 'CUDA Scalar' with linespoints ls 1 lw 2 lc rgb '#feb24c' pt 7 ps 1"
